...
import { Zone, Street } from 'src/app/models/zone.model';
import { getStreetsFromGeoJson } from 'src/app/utils/geojson.utils';
import { environment } from 'src/environments/environment';
import { StreetUsageService } from 'src/app/services/street-usage.service';
...
export class RegisterStep2Component implements OnInit {
  // Type for usage aggregation
  private static readonly UsageDistanceMeters = 35;
  ...
  private usageLayerGroup: L.LayerGroup = new L.LayerGroup();
  ...
  private jardinCarthagePolygonCoords: [number, number][] = [
    [36.8608784, 10.3034741],
    [36.8608732, 10.3035647],
    [36.8608736, 10.3036648],
    [36.8608932, 10.3037591],
    [36.8609115, 10.3038265],
    [36.8611681, 10.3040158],
    [36.8611895, 10.3040011],
    [36.8612967, 10.3039705],
    [36.8614019, 10.30394],
    [36.8614521, 10.3038156],
    [36.8614993, 10.3037258],
    [36.8615322, 10.3036336],
    [36.8615001, 10.3034356],
    [36.8614848, 10.3033187],
    [36.8615515, 10.303167],
    [36.8617034, 10.3027398],
    [36.8618677, 10.3021449],
    [36.8619448, 10.3017557],
    [36.8620103, 10.3014111],
    [36.8620792, 10.3008206],
    [36.8620879, 10.3003448],
    [36.8621018, 10.300193],
    [36.8620975, 10.2996441],
    [36.8620546, 10.2992928],
    [36.8619885, 10.2988653],
    [36.8619196, 10.2985349],
    [36.8618923, 10.298068],
    [36.8619051, 10.2979587],
    [36.8618838, 10.2978701],
    [36.8618564, 10.2978086],
    [36.8618519, 10.2977336],
    [36.8618743, 10.2974937],
    [36.8618519, 10.2972063],
    [36.8617462, 10.2966888],
    [36.861526, 10.2958611],
    [36.8613227, 10.2936727],
    [36.8612735, 10.2934112],
    [36.8612064, 10.2932164],
    [36.8608236, 10.2926508],
    [36.8606023, 10.2923143],
    [36.8605314, 10.2921604],
    [36.8605063, 10.2920228],
    [36.8604431, 10.2919348],
    [36.8603185, 10.2919095],
    [36.8601956, 10.291693],
    [36.8601579, 10.2915553],
    [36.8584693, 10.293048],
    [36.8583256, 10.2930325],
    [36.8582, 10.2930647],
    [36.858001, 10.2931558],
    [36.8567717, 10.2915292],
    [36.8564705, 10.2912246],
    [36.8542056, 10.2881141],
    [36.8533764, 10.289372],
    [36.8514087, 10.2908652],
    [36.8495798, 10.2921673],
    [36.8493626, 10.2921754],
    [36.848661, 10.2933874],
    [36.8482583, 10.2930281],
    [36.847384, 10.2939638],
    [36.8486941, 10.2967045],
    [36.8488537, 10.2968141],
    [36.8509208, 10.3011741],
    [36.8494028, 10.3023391],
    [36.849051, 10.3026703],
    [36.8483206, 10.3034347],
    [36.851257, 10.3058869],
    [36.8518123, 10.306279],
    [36.8523395, 10.3062435],
    [36.8523826, 10.3064181],
    [36.8524795, 10.3066199],
    [36.8525703, 10.3067441],
    [36.8526878, 10.3068381],
    [36.8532392, 10.3071877],
    [36.8535337, 10.3073284],
    [36.8538444, 10.3074566],
    [36.8541602, 10.3075636],
    [36.8544203, 10.3075928],
    [36.854584, 10.3076327],
    [36.8546525, 10.3077419],
    [36.8546736, 10.307841],
    [36.8546787, 10.3078964],
    [36.8547333, 10.3080884],
    [36.8548335, 10.308342],
    [36.855008, 10.3086094],
    [36.855213, 10.3088568],
    [36.8554309, 10.3090388],
    [36.855626, 10.3091684],
    [36.8558779, 10.3092566],
    [36.8561861, 10.3092996],
    [36.8564717, 10.3092689],
    [36.8567545, 10.3091731],
    [36.8570099, 10.3090065],
    [36.8573257, 10.3087675],
    [36.8573609, 10.3087342],
    [36.8575461, 10.308558],
    [36.8578332, 10.3082247],
    [36.8581002, 10.3078273],
    [36.8582384, 10.3075589],
    [36.8584087, 10.3071914],
    [36.8585603, 10.3067903],
    [36.858679, 10.3063526],
    [36.8588121, 10.3056277],
    [36.8588253, 10.3055399],
    [36.8588316, 10.3054223],
    [36.858844, 10.3052172],
    [36.8588558, 10.3050369],
    [36.8588571, 10.3046977],
    [36.8588358, 10.3044295],
    [36.8588193, 10.3042717],
    [36.8588267, 10.3042145],
    [36.8589183, 10.3041455],
    [36.8592731, 10.3038931],
    [36.8595107, 10.303681],
    [36.8598182, 10.3033437],
    [36.8600438, 10.3030453],
    [36.8601444, 10.302877],
    [36.860218, 10.3028605],
    [36.8608242, 10.3034164],
    [36.8608784, 10.3034741],
  ];
  ...
  private usageService = new StreetUsageService();
  ...
  private initMap(): void {
    ...
    // Streets (CRUD) will be on a lower pane; usage/occupancy overlays on a higher pane
    const streetsPane = this.map.createPane('streetsPane');
    streetsPane.style.zIndex = '450';
    this.usageService.ensureUsagePane(this.map);
    ...
    this.map.on('click', (e: L.LeafletMouseEvent) => {
      ...
      if (foundStreet) {
        // Try to match CRUD street to get capacity
        const matchedCrudStreet = this.streets.find(
          (s) =>
            this.normalizeName(s.name) === this.normalizeName(foundStreet!.name)
        );
        const cap = matchedCrudStreet?.capacity;
        L.popup()
          .setLatLng([lat, lng])
          .setContent(
            `
            <b>${foundStreet.name || 'Unnamed Street'}</b><br>
            Users: ${foundStreet.userCount}${cap ? ` / Capacity: ${cap}` : ''}
          `
          )
          .openOn(this.map!);
      }
    ...
    // Add usage overlay layer to map (drawn in usagePane)
    this.usageLayerGroup.addTo(this.map);
  }
  ...
  reverseGeocode(lat: number, lng: number) {
    ...
    if (isInJardinCarthage) {
      ...
      this.http
        .get<any>(
          `${environment.apiBaseUrl}/zone/check-parking-zone?lat=${lat}&lon=${lng}`
        )
        .subscribe({
          next: (apiRes) => {
            ...
            if (apiRes.message === 'You are good to park your car') {
              this.http
                .get<any>(
                  `${environment.geocoding.reverse}&lat=${lat}&lon=${lng}`
                )
                .subscribe({
                  next: (res) => {
              ...
              apiRes.message === 'You are in the zone but not in a parking area'
            ) {
              this.infoMessage =
              ...
              this.infoMessage =
                apiRes.message || 'Error checking parking zone';
              this.showConfirm = false;
            }
          },
          error: () => {
  ...
  onSearch() {
    ...
    if (latLngMatch) {
      ...
      this.http
        .get<any>(
          `${environment.geocoding.search}&q=${encodeURIComponent(
            this.searchQuery
          )}`
        )
        .subscribe((results) => {
  ...
  loadAndColorLocations() {
    // Fetch live locations and recompute usage for CRUD streets
    this.http
      .get<any[]>('http://localhost:8080/api/locations')
      .subscribe((locations) => {
        this.latestLocations = Array.isArray(locations) ? locations : [];
        this.recomputeStreetsUsageFromCRUD();
        // Redraw base streets to update colors, which will in turn draw overlay
  ...
  loadZonesAndStreets() {
    ...
    this.zoneService.getAllStreets().subscribe((streets) => {
      ...
      // If we have latest locations, recompute usage before displaying streets
      if (this.latestLocations && this.latestLocations.length > 0) {
        this.recomputeStreetsUsageFromCRUD();
      }
      this.displayStreetsOnMap();
    });
  ...
  displayZonesOnMap() {
    ...
    this.zones.forEach((zone) => {
      // Support either GeoJSON geometry or legacy coordinates field
      let coords: [number, number][] | null = null;
      if (
        zone.geometry &&
        zone.geometry.type === 'Polygon' &&
        zone.geometry.coordinates?.length
      ) {
        const firstRing = zone.geometry.coordinates[0]; // [ [lng,lat] or [lat,lng], ... ]
        coords = firstRing.map((pair) => this.toLatLng(pair)) as [
          number,
          number
        ][];
      } else if (zone.coordinates && zone.coordinates.length > 0) {
        // Legacy field: [ [lng,lat] or [lat,lng], ... ]
        coords = zone.coordinates.map((coord) => this.toLatLng(coord)) as [
          number,
          number
        ][];
      }
  ...
  displayStreetsOnMap() {
    ...
    // Clear usage overlays; we'll redraw per-street with fresh data
    this.usageLayerGroup.clearLayers();
    ...
    this.streets.forEach((street) => {
      if (street.coordinates && street.coordinates.length > 0) {
        ...
        // Default base color: neutral grey (uncolored by occupancy)
        const matchedCount = this.countUsersNearCoords(coords);
        const baseColor = '#9e9e9e';

        const polyline = L.polyline(coords, {
          color: baseColor,
          weight: 4,
          opacity: 0.35, // subtle base so overlay stands out
          pane: 'streetsPane',
          className: 'crud-street',
        }).addTo(this.streetLayerGroup);

        const buildPopupHtml = (count: number | undefined) => `
          <div>
            <h6>${street.name}</h6>
            <p>Zone: ${street.zoneName || ''}</p>
            <p>Parkable: ${street.isParkable ? 'Yes' : 'No'}</p>
            <p>Capacity: ${street.capacity ?? 'N/A'}</p>
            <p>Users: ${count ?? 0}${
          street.capacity ? ` / Capacity: ${street.capacity}` : ''
        }</p>
            <button onclick="window.editStreet('${
              street.id
            }')" class="btn btn-sm btn-primary">Edit</button>
            <button onclick="window.deleteStreet('${
              street.id
            }')" class="btn btn-sm btn-danger">Delete</button>
          </div>
        `;

        polyline.bindPopup(buildPopupHtml(matchedCount));
        // Recompute on popup open to keep the number fresh
        polyline.on('popupopen', () => {
          const refreshed = this.countUsersNearCoords(coords) ?? 0;
          (polyline.getPopup() as any)?.setContent(buildPopupHtml(refreshed));
        });

        // Draw per-street usage overlay now
        const capVal = (street as any).capacity;
        const capNum =
          typeof capVal === 'number'
            ? capVal
            : capVal != null
            ? Number(capVal)
            : undefined;
        if (matchedCount > 0) {
          const color = this.getOccupancyColor(matchedCount, capNum);
          L.polyline(coords, {
            color,
            weight: 6,
            dashArray: '8, 0',
            opacity: 0.8,
            pane: 'usagePane',
          }).addTo(this.usageLayerGroup);
        }
      }
    });

    this.streetLayerGroup.addTo(this.map!);
    // Per-street overlays already drawn above
  }

  // Count users near a given street coordinate path using the latest locations
  private countUsersNearCoords(coords: [number, number][]): number {
    if (!this.latestLocations || this.latestLocations.length === 0) return 0;
    let count = 0;
    for (const loc of this.latestLocations) {
      const lat = loc.latitude;
      const lng = loc.longitude;
      if (typeof lat !== 'number' || typeof lng !== 'number') continue;
      const d = this.usageService.pointToLineDistance(lat, lng, coords);
      if (d < RegisterStep2Component.UsageDistanceMeters) count++;
    }
    return count;
  }

  // Match CRUD street to aggregated user counts from loadAndColorLocations
  private getUserCountForStreet(
    street: Street,
    coords: [number, number][]
  ): number | undefined {
    if (!this.streetsData || this.streetsData.length === 0) return undefined;
    // 1) Try by name (case-insensitive, accent-insensitive)
    const sName = this.normalizeName(street.name || '');
    if (sName) {
      const byName = this.streetsData.find(
        (s) => this.normalizeName(s.name) === sName
      );
      if (byName) return byName.userCount;
    }
    // 2) Fallback: use proximity of mid-point to nearest aggregated street
    const mid = coords[Math.floor(coords.length / 2)];
    const lat = mid[0],
      lng = mid[1];
    type StreetUsageEntry = {
      name: string;
      coords: [number, number][];
      userCount: number;
    };
    let best: { street: StreetUsageEntry; dist: number } | null = null;
    for (const s of this.streetsData) {
      const d = this.pointToLineDistance(lat, lng, s.coords);
      if (!best || d < best.dist) best = { street: s, dist: d };
    }
    // Consider it a match only if close enough (e.g., 50m)
    if (best && best.dist <= 50) return best.street.userCount;
    return undefined;
  }
  ...
  private getOccupancyColor(
    ...
    if (!capNum || capNum <= 0 || isNaN(capNum)) {
      ...
      if (userCount <= 6) return '#fd7e14'; // orange
      return '#dc3545'; // red
    }
    const ratio = userCount / capNum;
    if (ratio < 0.5) return '#28a745'; // <50% free
    if (ratio < 0.8) return '#fd7e14'; // 50-80%
    return '#dc3545';
  }

  // Recompute usage counts based on CRUD streets and latest locations
  private recomputeStreetsUsageFromCRUD() {
    if (!this.map || !this.streets || this.streets.length === 0) return;
    const usage: {
      name: string;
      coords: [number, number][];
      userCount: number;
    ...
    for (const s of this.streets) {
      ...
      const coords = s.coordinates.map((c) => this.toLatLng(c)) as [
        number,
        number
      ][];
      let count = 0;
      ...
      const capVal = (s as any).capacity;
      const capNum2 =
        typeof capVal === 'number'
          ? capVal
          : capVal != null
      ...
      usage.push({
        ...
        coords,
        userCount: count,
        capacity: capNum2 != null && !isNaN(capNum2 as any) ? capNum2 : null,
        id: s.id as any,
      });
    }
    this.streetsData = usage;
  }

  // Draw usage overlay lines above base streets
  private drawUsageOverlay() {
    if (!this.map) return;
    this.usageLayerGroup.clearLayers();
    if (!this.streetsData || this.streetsData.length === 0) return;
    for (const u of this.streetsData) {
      if (!u.coords || u.coords.length < 2) continue;
      if (!u.userCount || u.userCount <= 0) continue; // only show overlay when there are users
      // Prefer capacity that came from CRUD when aggregating
      const capacity = u.capacity ?? null;
      const color = this.getOccupancyColor(u.userCount, capacity ?? undefined);
      L.polyline(u.coords, {
        color,
        weight: 6,
        dashArray: '8, 0',
        ...
        .addTo(this.usageLayerGroup)
        .bindPopup(
          `<b>${u.name || 'Unnamed Street'}</b><br>Users: ${u.userCount}${
  ...
  parseZoneCoordinates() {
    try {
      ...
      // Accepted formats:
      // - "lat1,lng1;lat2,lng2;..." OR "lng1,lat1;lng2,lat2;..." (auto-detected)
      // - JSON array: [[lat,lng], ...] OR [[lng,lat], ...]
      // - JSON nested one level: [[[lat,lng], ...]]
      // - JSON with objects: [{lat: x, lng: y}, ...] or {latitude, longitude}
      ...
      this.infoMessage =
        'Invalid coordinate format. Use: lat,lng pairs (semicolon-separated) or a JSON array of [lat,lng] pairs.';
    }
  }
  ...
  parseCoordinatesFromText(text: string): number[][] {
    ...
    if (text.startsWith('[')) {
      ...
      try {
        ...
        // Some users paste multiple [a,b] pairs without an outer array
        // Try wrapping with [ ... ] and parse again
        try {
          parsed = JSON.parse(`[${text}]`);
        } catch (e2) {
          throw e2;
      ...
      const pairs: Array<number[]> = this.normalizeToPairs(parsed);
      return pairs.map((coord) => this.toLngLat(coord));
    }

    // Parse semicolon-separated coordinates
    const coordinatePairs = text.split(';');
    return coordinatePairs.map((pair) => {
      const [a, b] = pair.split(',').map((n) => parseFloat(n.trim()));
      if (isNaN(a) || isNaN(b)) {
        throw new Error('Invalid coordinate pair: ' + pair);
      }
      return this.toLngLat([a, b]);
    });
  }

  private toLatLng(coord: number[]): [number, number] {
    const [a, b] = coord;
  ...
  private normalizeToPairs(input: any): number[][] {
    // Handle nested arrays [[[lat,lng],...]] -> [[lat,lng],...]
    let arr = input;
    ...
    if (
      ...
      return arr.map((o: any) => {
        ...
        if (typeof lat !== 'number' || typeof lng !== 'number') {
          throw new Error('Invalid coordinate object: ' + JSON.stringify(o));
        }
        return [lat, lng];
      });
    }
  ...
  private toLngLat(coord: number[]): number[] {
    const [a, b] = coord;
    if (typeof a !== 'number' || typeof b !== 'number') {
      throw new Error('Invalid coordinate: ' + JSON.stringify(coord));
    }
    // Detect if input is [lat,lng] vs [lng,lat]
    const isLatLng = Math.abs(a) <= 90 && Math.abs(b) <= 180;
    const lat = isLatLng ? a : b;
    const lng = isLatLng ? b : a;
    return [lng, lat];
  }

  // Zone CRUD methods
  saveZone() {
    // Parse as JSON and preserve order/format
    if (this.zoneCoordinatesText && this.zoneCoordinatesText.trim()) {
      try {
        this.zoneForm.coordinates = JSON.parse(this.zoneCoordinatesText);
      } catch (e) {
        console.error('Failed to parse zone coordinates on save:', e);
        this.infoMessage =
          'Failed to parse zone coordinates. Please check the JSON format.';
        return;
      }
    }
    if (this.isEditing && this.selectedZone) {
      this.zoneService
        .updateZone(this.selectedZone.id!, this.zoneForm)
        .subscribe({
          next: () => {
            this.loadZonesAndStreets();
            this.resetForms();
  ...
  editZone(zoneId: number) {
    ...
    if (zone) {
      ...
      this.zoneForm = { ...zone };
      // Preserve coordinates as pretty JSON for editing
      if (zone.coordinates && zone.coordinates.length > 0) {
        this.zoneCoordinatesText = JSON.stringify(zone.coordinates, null, 2);
      } else {
      ...
      setTimeout(() => {
        const el = document.getElementById('zone-form-section');
        if (el) {
  ...
  saveStreet() {
    ...
    if (this.streetCoordinatesText && this.streetCoordinatesText.trim()) {
      try {
        this.streetForm.coordinates = JSON.parse(this.streetCoordinatesText);
      } catch (e) {
        console.error('Failed to parse street coordinates on save:', e);
        this.infoMessage =
          'Failed to parse street coordinates. Please check the JSON format.';
        return;
      }
    }
    // Ensure numeric capacity
    if (
      this.streetForm.capacity === undefined ||
      this.streetForm.capacity === null
    ) {
      this.streetForm.capacity = 0;
    } else {
      this.streetForm.capacity = Number(this.streetForm.capacity);
    }
    if (this.isEditing && this.selectedStreet) {
      this.zoneService
        .updateStreet(this.selectedStreet.id!, this.streetForm)
        .subscribe({
          next: () => {
            this.loadZonesAndStreets();
            this.resetForms();
  ...
  editStreet(streetId: string) {
    ...
    if (street) {
      ...
      // Preserve coordinates as pretty JSON for editing
      if (street.coordinates && street.coordinates.length > 0) {
        this.streetCoordinatesText = JSON.stringify(street.coordinates, null, 2);
      } else {
  ...
  hasZoneCoordinates(): boolean {
    return !!(
      this.zoneForm.coordinates && this.zoneForm.coordinates.length > 0
    );
  }

  hasStreetCoordinates(): boolean {
    return !!(
      this.streetForm.coordinates && this.streetForm.coordinates.length > 0
    );
  }
